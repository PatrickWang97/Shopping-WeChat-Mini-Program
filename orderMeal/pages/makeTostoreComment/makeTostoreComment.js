...
Page({
  data: {
    ...
    submitData: {
      ...
      goods: [],
      tostore_score: 5,
      tostore_environment_score: 5,
      tostore_seller_serve_score: 5
    }
  },
  ...
  setTostoreScore: function (e) {
    var score = e.target.dataset.score;
    this.setData({
      'submitData.tostore_score': score
    })
  },
  setTostoreEnvironmentScore: function (e) {
    var score = e.target.dataset.score;
    this.setData({
      'submitData.tostore_environment_score': score
    })
  },
  setTostoreSellerServeScore: function(e){
    var score = e.target.dataset.score;
    this.setData({
      'submitData.tostore_seller_serve_score': score
    })
  },
