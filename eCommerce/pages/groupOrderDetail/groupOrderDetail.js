...
Page({
  ...
  onShareAppMessage: function (e) {
    let that = this,
        ...
        url = '/eCommerce/pages/joinGroupDetail/joinGroupDetail?detail=' + goodsInfo.goods_id + '&teamToken=' + teamToken + (franchisee ? '&franchisee=' + franchisee : '') + (appInstance.globalData.pageShareKey ? ('&psid=' + appInstance.globalData.pageShareKey) : ''),
