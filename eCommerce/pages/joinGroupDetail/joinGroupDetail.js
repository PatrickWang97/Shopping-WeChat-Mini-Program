...
Page({
  ...
  onShareAppMessage: function () {
    var that = this,
      ...
      url = '/pages/groupGoodsDetail/groupGoodsDetail?detail=' + goodsId + '&contact=' + contact + (franchiseeId ? '&franchisee=' + franchiseeId : '') + (app.globalData.pageShareKey ? ('&psid=' + app.globalData.pageShareKey) : '');
